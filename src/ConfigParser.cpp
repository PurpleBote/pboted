...
void Init() {
  ...
  general.add_options()
      ...
      ("version", "Show pbote version")
      ("conf",
       value<std::string>()->default_value(""),
       "Path to main pbote config file (default: try ~/.pbote/pbote.conf or /var/lib/pbote/pbote.conf)")
      ("pidfile",
       value<std::string>()->default_value(""),
       "Path to pidfile (default: ~/pbote/pbote.pid or /var/lib/pbote/pbote.pid)")
      ...
      ("datadir",
       value<std::string>()->default_value(""),
       "Path to storage of pbote data (RI, keys, peer profiles, ...) (default: try ~/.pbote/data/ or /var/lib/pbote/data/)")
      ...
      ("service",
       bool_switch()->default_value(false),
       "Router will use system folders like '/var/lib/pbote' (default: disabled)");
...
void ParseCmdline(int argc, char *argv[], bool ignoreUnknown) {
  ...
  if (!ignoreUnknown && (m_Options.count("help") || m_Options.count("h"))) {
    std::cout << "pbote version " << PBOTE_VERSION << " (" << PBOTE_VERSION << ")" << std::endl;
